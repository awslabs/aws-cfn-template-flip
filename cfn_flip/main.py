...
def main():
    ...
    parser.add_argument("-i", "--indent", nargs="?", type=int, help="Number of spaces used for indenting. Defaults are YAML=2, JSON=4")
    ...
    try:
        args.output.write(flip(template, args.clean, args.indent))
